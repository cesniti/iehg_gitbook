...
If you want to know more about the ECDIS Standard Edition 2.0 :

{% page-ref page="standard-iecdis/standard-2.0/" %}

## Switch between Editions of the ECDIS Standard

![switch shown ECDIS Standard edition](.gitbook/assets/editions-crop-to-gif.gif)
